...
<title><?php global $page, $paged;
  wp_title( '|', true, 'right' );
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'tpl_021_rwd' ), max( $paged, $page ) );
	?></title>
<link rel="profile" href="http://gmpg.org/xfn/11">
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'stylesheet_url' ); ?>?version=2016-04-18">
...
<script src="<?php bloginfo('template_url'); ?>/js/jquery.iframe-auto-height.plugin.1.9.5.js"></script>
</head>
<body>
